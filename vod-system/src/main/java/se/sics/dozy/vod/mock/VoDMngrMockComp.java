...
//            List<TorrentExtendedStatus> lesList = new ArrayList<>();
//            for(Map.Entry<Identifier, Pair<FileInfo, TorrentInfo>> e : libraryContents.entrySet()) {
//                TorrentExtendedStatus les = new TorrentExtendedStatus(e.getValue().getValue0().name, e.getValue().getValue1().status, e.getKey());
//                lesList.add(les);
//            }
