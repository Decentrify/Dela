...
public class ExtendedDetails {
  ...
  private List kafkaDetails;

  public ExtendedDetails() {
  }

  public ExtendedDetails(List<HDFSDetails> hdfsDetails) {
    this.hdfsDetails = hdfsDetails;
    this.kafkaDetails = new LinkedList<>();
  }
  ...
  public List getKafkaDetails() {
    return kafkaDetails;
  }

  public void setKafkaDetails(List kafkaDetails) {
